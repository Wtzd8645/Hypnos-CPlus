...
UdpListener::UdpListener(ConnectionListenerConfig& config, Container::UnorderedMap<uint16, MulticastDelegate<RequestBase&>*>& reqHandlerDict) :
...
inline void UdpListener::Receive()
{
    ...
    while (true)
    {
        ...
        // if (!requestProducer->Create(receiveBuf + sizeof(packet_size), *connId))
        // {
