...
{
public:
    SocketListenerBase(ConnectionListenerConfig& config, Container::UnorderedMap<uint16, MulticastDelegate<RequestBase&>*>& requestHandlerMap) :
...
protected:
    ...
    Container::UnorderedMap<uint16, MulticastDelegate<RequestBase&>*>& requestHandlerMap;
